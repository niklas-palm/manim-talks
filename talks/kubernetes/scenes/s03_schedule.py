...
class SchedulerKubelet(TalkSlide):
    def construct(self):
        ...
        out = label("no room", 15, HOT).scale(ZN).next_to(n3[3], DOWN, buff=0.06).align_to(n3[3], LEFT)
