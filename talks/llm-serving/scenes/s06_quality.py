...
class NoiseFloor(TalkSlide):
    def construct(self):
        ...
        self.next_slide("""100 questions from a standard benchmark, each dot one question, scored right or wrong. One hundred items from a standard benchmark, each scored pass or fail, on a bf16 deployment. Now deploy the same
