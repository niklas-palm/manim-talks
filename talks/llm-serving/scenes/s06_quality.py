...
class NoiseFloor(TalkSlide):
    def construct(self):
        ...
        self.finish("""The picture hands over. The still picture: the same hundred questions as the last scene, every dot grey, no answer changed yet. Each click from here compares one precision against the same model in bf16.""")
